 ...
 */
template <class T> Edge<T> *Vertex<T>::addEdge(Vertex<T> *d, double dw, double ww) {
...
template <class T> int Vertex<T>::getLow() const {
    return this->low;
}

template <class T> void Vertex<T>::setLow(int value) {
    this->low = value;
}

template <class T> int Vertex<T>::getNum() const {
    return this->num;
}

template <class T> void Vertex<T>::setNum(int value) {
    this->num = value;
}
...
template <class T> bool Vertex<T>::isVisited() const {
    return this->visited;
}
...
template <class T> Edge<T> *Vertex<T>::getPath() const {
    return this->path;
}
...
template <class T> void Vertex<T>::setInfo(T in) {
    this->info = in;
}
...
template <class T> void Vertex<T>::setPath(Edge<T> *path) {
    this->path = path;
}
...
template <class T> Vertex<T> *Edge<T>::getOrig() const {
    return this->orig;
}
...
template <class T> bool Edge<T>::isSelected() const {
    return this->selected;
}

template <class T> double Edge<T>::getFlow() const {
    return flow;
}
...
template <class T> void Edge<T>::setFlow(double flow) {
    this->flow = flow;
}
 ...
 * Auxiliary function to find a vertex with a given code.
 */
template <class T> Vertex<T> *Graph<T>::findVertexByCode(const std::string code) const {
    for (auto v : vertexSet)
 ...
 * does not exist.
 */
template <class T> bool Graph<T>::addEdge(const T &sourc, const T &dest, double dw, double ww) {
